...
export const propertySchema = z.object({
  ...
  type: z.enum(['house', 'apartment', 'condo', 'commercial', 'land', '']).refine((v) => v !== '', {
    message: 'Property type is required',
  }),

  access: z.enum(['private', 'shared', 'public road', '']).refine((v) => v !== '', {
