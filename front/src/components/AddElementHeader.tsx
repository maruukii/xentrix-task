...
const AddElementHeader = ({ breadcrumb }: { breadcrumb: string }) => {
  ...
  return (
    <div className="flex w-full items-center justify-between rounded-lg bg-white px-8 py-6 shadow-[0_4px_8px_0_rgba(0,0,0,0.1)]">
      ...
      <button
        className="border-primary-content hover:bg-primary flex h-[54px] w-fit cursor-pointer items-center gap-3 rounded-md border-2 px-6 py-4"
        onClick={() =>
          navigate(`/${window.location.pathname.split('/')[1]}/new`, {
